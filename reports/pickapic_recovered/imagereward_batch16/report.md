> Compact export. Full tables and raw data are indexed in [artifact_index.json](artifact_index.json) and remain at `/e/project1/taco-vlm/avrecum/DatasetDifferencesApplicationsCode/runs/batch16_verification/imagereward/analysis`. Relative full-table links refer to that original directory.
...
Patch budget: 1024; vocabulary: 54030. The 1,024-patch pilot differs from the supplied fg_clip.py 16,384-patch setting. Frozen score configuration: `442d8c31ff80c7403654849976f56b83305bad2d7a0c8a56255b983b1e7e0c16`.
...
| lip-smacking | preferred | 0.0042 | 0.0020 [-0.0011, 0.0052] | 0.5055 |
